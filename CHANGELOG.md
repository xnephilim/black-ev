...
- (tests) [#1434](https://github.com/evmos/evmos/pull/1434) Set default staking denom to `ablack` in `evm` and `feemarket` tests
...
- (cmd) [\#543](https://github.com/evmos/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025ablack`.
